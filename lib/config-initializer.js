...
console.trace()
		...
		return subStringPath=>{
			...
			if (subStringPath=='.'){
				return {...configItem, _global: config.global, _meta,_log: log  };
			}
			...
			return {...configElement, _global: config.global, _meta ,_log: log  };
	...
	return { getElement, showAll, makeRetriever };
